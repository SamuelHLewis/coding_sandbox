...
#### OpenCode
Note: this command was valid as of 26/06/2026, but is fragile to the OpenCode system filepaths changing.
```
opencode_sandboxed() {
...
Once the podman VM is running, use one of the custom commands defined in the previous section to launch a coding assistant within a container. You should specify the path to your working dir as the first argument e.g. for OpenCode:
```
